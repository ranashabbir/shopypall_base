      ...
      if(move_uploaded_file($source, $target_path)) {
        ...
        if($settings_data['admin_version'] == $version['version']){
          ...
          if($version['souce_file'] == 'application' ){
               if($purchase_id == "20952416" or $purchase_id == "20757378" or $purchase_id == "27944998"){
  ...
  public function updatercontent(Request $request){
    ...
    if(move_uploaded_file($source, $target_path)) {
      ...
      if($settings_data['admin_version'] == $version['version'] and $version['souce_file'] != 'admin'){
        ...
        if($purchase_id == "26827707" or $purchase_id == "26840547" or $purchase_id == "28681648" or $purchase_id == "27944998"  or $purchase_id == "20952416" or $purchase_id == "20757378" or $purchase_id == "22334657"){
          //$existing_version
          $status_name = '';
          $app_version_name = '';
