    ...
    <div class="content">
      ...
      <div class="pro-counter">
          <div class="input-group item-quantity">
            ...
            <input name="products_{{$products->products_id}}" type="text" readonly value="{{$products->products_min_order}}" class="form-control qty products_{{$products->products_id}}" min="{{$products->products_min_order}}" max="{{$products->defaultStock}}">
